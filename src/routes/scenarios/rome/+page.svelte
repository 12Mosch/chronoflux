	...
	const nations = [
		{
			...
			name: 'Roman Republic',
			government: 'Republic',
			description: 'The dominant Mediterranean power'
		},
		{
			id: 'egypt',
			name: 'Ptolemaic Egypt',
			government: 'Monarchy',
			description: 'Ancient kingdom with vast wealth'
		},
		{
			id: 'carthage',
			name: 'Carthage',
			government: 'Oligarchy',
			description: 'Trading power with naval strength'
		}
	];
...
<div class="mx-auto max-w-4xl">
	<div class="mb-8">
		<h1 class="mb-2 text-3xl font-bold">Ancient Rome - 44 BC</h1>
