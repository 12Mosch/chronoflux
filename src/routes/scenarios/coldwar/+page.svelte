	...
	const nations = [
		{
			...
			description: 'Western superpower with strong economy'
		},
		{
			id: 'ussr',
			name: 'Soviet Union',
			government: 'Communist',
			description: 'Eastern superpower with military might'
		}
	];
...
<div class="mx-auto max-w-4xl">
	<div class="mb-8">
		<h1 class="mb-2 text-3xl font-bold">Cold War - 1947</h1>
		<p class="text-slate-400">Select a superpower to control</p>
	</div>
